...
$lang_translator['createdate'] = '18/11/2025, 12:00';
$lang_translator['copyright'] = '@Copyright (C) 2009-2025 VINADES.,JSC. All rights reserved';
$lang_translator['info'] = '';
$lang_translator['langtype'] = 'lang_module';

// Menu
$lang_module['item_list'] = 'Danh sách';
$lang_module['item_add'] = 'Thêm mới';
$lang_module['item_edit'] = 'Sửa';

// Fields
$lang_module['title'] = 'Tiêu đề';
$lang_module['alias'] = 'Liên kết tĩnh';
$lang_module['alias_hint'] = 'Để trống để tự động tạo';
...
$lang_module['hits'] = 'Lượt xem';
$lang_module['publish_time'] = 'Thời gian xuất bản';

// Status
$lang_module['status_draft'] = 'Bản nháp';
$lang_module['status_published'] = 'Xuất bản';
...
$lang_module['error_alias_exists'] = 'Liên kết tĩnh đã tồn tại';
